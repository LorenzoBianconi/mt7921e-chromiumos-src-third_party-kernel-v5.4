...
#define MTK_VCODEC_ENC_AVC_NAME	"mtk-vcodec-enc"
#define MTK_VCODEC_ENC_VP8_NAME	"mtk-venc-vp8"
...
static int mtk_vcodec_probe(struct platform_device *pdev)
{
	...
	dev->encode_workqueue =
			alloc_ordered_workqueue(dev->venc_pdata->name,
						WQ_MEM_RECLAIM |
						WQ_FREEZABLE);
